...
// src/app/features/orders/components/invoice-view/invoice-view.component.ts
...
@Component({
  ...
  template: `
    <div class="container mx-auto p-4">
      ...
      <div *ngIf="invoice && order" id="invoice-container" class="bg-white rounded-lg shadow-md p-8 mb-6">
